...
export default function Sidebar({ myVis }: Props) {
	const { isConnected, connect, uNameVal, account, isAuth }: conn =
	...
	return (
		<div className={`si-cont ${showMe ? "si-slide-in" : "si-slide-out"}`}>
			<div
				className={`si-sidebar-reactive ${
					showMe ? "si-slide-in" : "si-slide-out"
				}`}
				onClick={() => {
					handleClick()
				}}
			...
			>
				...
				<div
					className="si-sidebar-menu fl-tl"
					onClick={() => {
						handleClick()
					}}
				>
				...
				<div className="si-connect-wrapper">
					<button
						className="si-connect fl-cc si-con-big"
						onClick={() => {
							!isConnected && connect()
						}}
					>
					...
					<button
						className="si-connect fl-cc si-con-small"
						onClick={() => {
							!isConnected
								? connect()
								: isAuth
